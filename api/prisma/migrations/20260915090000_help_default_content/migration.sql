-- Contenido inicial del centro de ayuda: viene de serie con la instalación.
-- Crea las categorías y los artículos que no existan y no toca nada que ya esté:
-- a partir del primer despliegue, el contenido se gestiona desde el panel de administración.

INSERT INTO "help_categories" ("id", "slug", "name", "description", "icon", "accent", "order_index", "updated_at")
VALUES (gen_random_uuid()::text, $itakai$primeros-pasos$itakai$, $itakai$Primeros pasos$itakai$, $itakai$Lo mínimo para tener tu primera clase funcionando.$itakai$, $itakai$primeros-pasos$itakai$, $itakai$ia$itakai$, 0, CURRENT_TIMESTAMP)
ON CONFLICT ("slug") DO NOTHING;

INSERT INTO "help_categories" ("id", "slug", "name", "description", "icon", "accent", "order_index", "updated_at")
VALUES (gen_random_uuid()::text, $itakai$clases$itakai$, $itakai$Clases$itakai$, $itakai$Crear, configurar, duplicar y compartir clases.$itakai$, $itakai$clases$itakai$, $itakai$stats$itakai$, 1, CURRENT_TIMESTAMP)
ON CONFLICT ("slug") DO NOTHING;

INSERT INTO "help_categories" ("id", "slug", "name", "description", "icon", "accent", "order_index", "updated_at")
VALUES (gen_random_uuid()::text, $itakai$misiones$itakai$, $itakai$Misiones y enigmas$itakai$, $itakai$El contenido: misiones, enigmas, entregas y revisión.$itakai$, $itakai$misiones$itakai$, $itakai$clases$itakai$, 2, CURRENT_TIMESTAMP)
ON CONFLICT ("slug") DO NOTHING;

INSERT INTO "help_categories" ("id", "slug", "name", "description", "icon", "accent", "order_index", "updated_at")
VALUES (gen_random_uuid()::text, $itakai$gamificacion$itakai$, $itakai$Gamificación$itakai$, $itakai$XP, monedas, maná, vidas, insignias, niveles y tienda.$itakai$, $itakai$gamificacion$itakai$, $itakai$pending$itakai$, 3, CURRENT_TIMESTAMP)
ON CONFLICT ("slug") DO NOTHING;

INSERT INTO "help_categories" ("id", "slug", "name", "description", "icon", "accent", "order_index", "updated_at")
VALUES (gen_random_uuid()::text, $itakai$alumnado$itakai$, $itakai$Alumnado$itakai$, $itakai$Cómo lo ve el alumno y cómo se gestiona.$itakai$, $itakai$alumnado$itakai$, $itakai$ia$itakai$, 4, CURRENT_TIMESTAMP)
ON CONFLICT ("slug") DO NOTHING;

INSERT INTO "help_categories" ("id", "slug", "name", "description", "icon", "accent", "order_index", "updated_at")
VALUES (gen_random_uuid()::text, $itakai$ia-y-configuracion$itakai$, $itakai$IA y configuración$itakai$, $itakai$Atenea, proveedores de inteligencia artificial y almacenamiento.$itakai$, $itakai$ia-y-configuracion$itakai$, $itakai$stats$itakai$, 5, CURRENT_TIMESTAMP)
ON CONFLICT ("slug") DO NOTHING;

INSERT INTO "help_categories" ("id", "slug", "name", "description", "icon", "accent", "order_index", "updated_at")
VALUES (gen_random_uuid()::text, $itakai$tu-cuenta$itakai$, $itakai$Tu cuenta$itakai$, $itakai$Accesibilidad, avisos y seguridad de tu perfil.$itakai$, $itakai$tu-cuenta$itakai$, $itakai$clases$itakai$, 6, CURRENT_TIMESTAMP)
ON CONFLICT ("slug") DO NOTHING;

INSERT INTO "help_categories" ("id", "slug", "name", "description", "icon", "accent", "order_index", "updated_at")
VALUES (gen_random_uuid()::text, $itakai$si-eres-alumno$itakai$, $itakai$Si eres alumno$itakai$, $itakai$Lo que necesitas saber tú, no tu profesor.$itakai$, $itakai$si-eres-alumno$itakai$, $itakai$pending$itakai$, 7, CURRENT_TIMESTAMP)
ON CONFLICT ("slug") DO NOTHING;

INSERT INTO "help_categories" ("id", "slug", "name", "description", "icon", "accent", "order_index", "updated_at")
VALUES (gen_random_uuid()::text, $itakai$cuando-algo-falla$itakai$, $itakai$Cuando algo falla$itakai$, $itakai$Lo que suele pasar y cómo se arregla.$itakai$, $itakai$cuando-algo-falla$itakai$, $itakai$ia$itakai$, 8, CURRENT_TIMESTAMP)
ON CONFLICT ("slug") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$que-es-itakai$itakai$, $itakai$Qué es ITAKAI y cómo funciona$itakai$, $itakai$La idea en cinco minutos: clases con historia, misiones que se entregan y recursos que se ganan.$itakai$, $itakai$/app/ayuda/recorrido.svg$itakai$, $itakai$ITAKAI convierte una asignatura en una aventura. Tú creas una **clase**, le pones una historia, y el temario se reparte en **misiones** que los alumnos completan entregando trabajo. Cada entrega que revisas reparte recursos, y esos recursos suben de nivel, compran cosas en la tienda de clase y aparecen en la clasificación.
...
Si es tu primera vez, el camino corto es: [crear una clase](/ayuda/primeros-pasos/crear-tu-primera-clase), [invitar a tus alumnos](/ayuda/primeros-pasos/invitar-alumnos-a-una-clase) y [escribir tu primera misión](/ayuda/misiones/crear-una-mision). Con eso ya tienes una clase viva; el resto se añade cuando lo necesites.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 0, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$primeros-pasos$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$crear-tu-primera-clase$itakai$, $itakai$Crear tu primera clase$itakai$, $itakai$El asistente de creación, paso a paso, y qué decisiones puedes cambiar después.$itakai$, $itakai$/app/ayuda/clase-nueva.svg$itakai$, $itakai$Desde **Mis clases**, el botón *Crear clase* abre un asistente que te va preguntando por partes. Ninguna decisión es definitiva: todo lo que eliges aquí se puede cambiar luego desde los ajustes de la clase.
...
Lo siguiente es [meter a tus alumnos](/ayuda/primeros-pasos/invitar-alumnos-a-una-clase) y [escribir la primera misión](/ayuda/misiones/crear-una-mision). Si prefieres no partir de cero, puedes [empezar desde una plantilla publicada por otro docente](/ayuda/clases/crear-una-clase-desde-cero-o-desde-una-plantilla).$itakai$, 'es', 'publicado'::"HelpArticleStatus", 1, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$primeros-pasos$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$invitar-alumnos-a-una-clase$itakai$, $itakai$Invitar alumnos a una clase$itakai$, $itakai$El código de clase, las invitaciones directas y qué hacer con las solicitudes que llegan.$itakai$, $itakai$/app/ayuda/invitar.svg$itakai$, $itakai$Hay dos caminos para que un alumno acabe dentro de tu clase, y conviene conocer los dos porque sirven para situaciones distintas.
...
> **Ojo con las clases archivadas.** Una clase archivada no admite invitaciones nuevas. Si vas a reutilizar una clase del curso pasado, mejor [duplicarla](/ayuda/clases/duplicar-una-clase-para-el-curso-siguiente) que desarchivarla.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$primeros-pasos$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$la-narrativa-de-tu-clase$itakai$, $itakai$La narrativa: por qué tu clase tiene una historia$itakai$, $itakai$Qué es la narrativa, dónde aparece y cómo escribirla con ayuda de la IA.$itakai$, $itakai$/app/ayuda/narrativa.svg$itakai$, $itakai$La narrativa es la historia que envuelve tu asignatura: un naufragio, una expedición, un misterio por resolver. No es un adorno de la portada — es el hilo del que tiran las misiones.
...
La plataforma tiene cinco personajes que acompañan al alumnado —Atenea, Odiseo, Penélope, Polifemo y Posidón— y cada uno tiene su color y su carácter. El que elijas para tu clase es quien da la cara en el asistente y en los mensajes del sistema. Es un detalle pequeño que hace mucho por la coherencia.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 3, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$primeros-pasos$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$crear-una-clase-desde-cero-o-desde-una-plantilla$itakai$, $itakai$Crear una clase desde cero o desde una plantilla$itakai$, $itakai$Qué te traes al importar una plantilla de otro docente y qué tienes que montar tú.$itakai$, $itakai$/app/ayuda/plantilla.svg$itakai$, $itakai$Además de crear una clase en blanco, puedes partir de una **plantilla**: una clase que otro docente ha publicado para que cualquiera la reutilice.
...
La clase importada es tuya y se edita como cualquier otra. Cambia lo que no encaje —precios, nombres, la propia narrativa— antes de dar el código a tus alumnos.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 0, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$clases$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$elegir-que-recursos-usa-tu-clase$itakai$, $itakai$Elegir qué recursos usa tu clase$itakai$, $itakai$Experiencia, monedas, maná, vidas, tienda, insignias y niveles: qué hace cada uno y cómo apagarlos.$itakai$, $itakai$/app/ayuda/recursos.svg$itakai$, $itakai$En *Ajustes* de la clase decides con qué juega tu grupo. Cada interruptor cambia lo que ven tus alumnos y lo que se reparte al revisar entregas.
...
> Empieza corto. Una clase con experiencia y misiones ya funciona el primer día; monedas, tienda y poderes se añaden cuando el grupo ya está rodado.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 1, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$clases$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$la-guia-de-clase$itakai$, $itakai$La guía de clase y la historia$itakai$, $itakai$El documento que tus alumnos consultan para saber de qué va todo esto.$itakai$, $itakai$/app/ayuda/guia.svg$itakai$, $itakai$La **guía de clase** es un documento libre que tus alumnos pueden abrir en cualquier momento. Sirve para lo que tú quieras: las reglas del juego, el contexto de la historia, cómo se puntúa, qué se espera de ellos.
...
La guía no es el sitio para el temario ni para los materiales: para eso están los documentos que puedes adjuntar a cada misión, que quedan junto al contenido al que pertenecen.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$clases$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$duplicar-una-clase-para-el-curso-siguiente$itakai$, $itakai$Duplicar una clase para el curso siguiente$itakai$, $itakai$Qué partes puedes copiar, qué se queda fuera siempre y por qué no conviene reutilizar la de siempre.$itakai$, $itakai$/app/ayuda/duplicar.svg$itakai$, $itakai$Cuando empieza un curso nuevo no hace falta rehacer el trabajo: desde el menú de la clase, *Duplicar* crea una copia limpia y te deja elegir qué te llevas.
...
Es tentador borrar a los alumnos del año pasado y volver a usar la misma clase, pero pierdes el histórico de un curso que puede que quieras consultar. Duplicando te quedas con las dos cosas: la clase del año pasado archivada y tal cual estaba, y una copia nueva lista para empezar.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 3, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$clases$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$publicar-tu-clase-como-plantilla$itakai$, $itakai$Publicar tu clase como plantilla$itakai$, $itakai$Compartir tu trabajo con el resto del profesorado, y qué se limpia antes de publicarlo.$itakai$, $itakai$/app/ayuda/publicar.svg$itakai$, $itakai$Si has montado una clase que funciona, puedes publicarla como **plantilla** para que cualquier otro docente de la instancia parta de ella.
...
Puedes retirar tu plantilla del catálogo cuando quieras. Quien ya la haya importado se queda con su copia: importar crea una clase independiente, no un enlace a la tuya.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 4, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$clases$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$crear-una-mision$itakai$, $itakai$Crear una misión$itakai$, $itakai$Título, rareza, fecha de entrega, portada y materiales: todo lo que define una misión.$itakai$, $itakai$/app/ayuda/mision.svg$itakai$, $itakai$Una misión es una unidad de trabajo con su propia historia. Se crea desde la pestaña *Misiones* de la clase, con un asistente parecido al de la clase.
...
Una misión puede estar **activa** —visible y entregable— o **bloqueada**, que la deja a la vista pero sin admitir entregas. Sirve para preparar contenido con antelación y abrirlo el día que toca.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 0, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$misiones$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$enigmas-los-pasos-de-una-mision$itakai$, $itakai$Enigmas: los pasos de una misión$itakai$, $itakai$Qué es un enigma, cómo se ordenan y qué entrega el alumno en cada uno.$itakai$, $itakai$/app/ayuda/enigmas.svg$itakai$, $itakai$El enigma es la unidad real de trabajo. La misión da el marco; el enigma es lo que el alumno hace, entrega y ve puntuado.
...
Cuando apruebas el enigma que faltaba, la misión se marca como completada y el alumno se lleva el bonus de rareza y la insignia asociada, si la misión tiene una. Eso ocurre una sola vez, en esa revisión.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 1, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$misiones$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$recompensas-xp-monedas-y-mana$itakai$, $itakai$Recompensas: XP, monedas y maná por enigma$itakai$, $itakai$Dónde se configura lo que vale cada cosa y cómo se calcula el total de una misión.$itakai$, $itakai$/app/ayuda/recompensas.svg$itakai$, $itakai$**Las recompensas se configuran en el enigma, no en la misión.** Es el detalle que más despista al principio: la misión no tiene un "vale 300 XP" propio, sino que suma lo de sus enigmas.
...
Un enigma puede tener monedas configuradas y no repartir ninguna, si la clase tiene las monedas desactivadas. Se reparte lo que la clase usa, no lo que el enigma dice.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 2, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$misiones$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$rarezas-y-fechas-de-entrega$itakai$, $itakai$Rarezas y fechas de entrega$itakai$, $itakai$Qué cambia según la rareza y qué pasa exactamente cuando vence una misión.$itakai$, $itakai$/app/ayuda/rarezas.svg$itakai$, $itakai$## Las cuatro rarezas
...
Las entregas que ya estuvieran pendientes las puedes seguir revisando con normalidad: vencer cierra la puerta de entrada, no tu trabajo de corrección. Si necesitas dar margen a alguien, mueve la fecha de la misión — y ojo, porque al moverla se vuelve a mandar el recordatorio con el plazo nuevo.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 3, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$misiones$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$revisar-entregas$itakai$, $itakai$Revisar entregas y puntuar por porcentaje$itakai$, $itakai$Un solo número reparte las tres recompensas. Cómo se calcula y qué no se puede deshacer.$itakai$, $itakai$/app/ayuda/entregas.svg$itakai$, $itakai$Cuando un alumno sube un archivo a un enigma, la entrega queda **pendiente** y te aparece en *Entregas*, dentro de la clase. Ahí decides con qué porcentaje se ha completado la tarea, y ese único número reparte todas las recompensas.
...
Un enigma ya aprobado **no se puede volver a aprobar**, ni siquiera desde una entrega nueva. Si un alumno sube otro archivo del mismo enigma, la plataforma no vuelve a pagar las recompensas. Es lo que evita que un enigma se cobre dos veces.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 4, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$misiones$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$monedas-y-tienda-de-clase$itakai$, $itakai$Monedas y tienda de clase$itakai$, $itakai$Montar la tienda: recompensas de un solo uso, recompensas para siempre y poderes que cuestan maná.$itakai$, $itakai$/app/ayuda/tienda.svg$itakai$, $itakai$La tienda es donde lo que el alumnado gana se convierte en algo que le importa. La montas tú, artículo a artículo, y decides los precios.
...
Es perfectamente válido. Desactiva las monedas y la tienda en los ajustes de la clase y la pantalla desaparece para todos.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 0, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$gamificacion$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$comportamientos-y-puntos-de-vida$itakai$, $itakai$Comportamientos y puntos de vida$itakai$, $itakai$Registrar lo que pasa en clase y que tenga consecuencia en el juego.$itakai$, $itakai$/app/ayuda/comportamientos.svg$itakai$, $itakai$Los comportamientos son la forma de que lo que ocurre en el aula —para bien y para mal— tenga efecto en la partida.
...
Todo lo aplicado queda con fecha, con quién lo aplicó y sobre quién. Está en el historial de la clase y en la ficha del alumno.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 1, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$gamificacion$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$insignias$itakai$, $itakai$Insignias$itakai$, $itakai$Reconocimientos que se ganan al completar misiones, con su imagen y su significado.$itakai$, $itakai$/app/ayuda/insignias.svg$itakai$, $itakai$Las insignias son el reconocimiento visible de algo conseguido. A diferencia de la experiencia o las monedas, no se gastan ni se pierden: se quedan en el perfil del alumno dentro de esa clase.
...
Una por misión importante, no una por misión. Si todas las misiones dan insignia, la colección deja de significar nada; si solo la dan las grandes, conseguir una es una noticia.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$gamificacion$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$niveles-y-rangos$itakai$, $itakai$Niveles y rangos$itakai$, $itakai$Cómo se sube de nivel, qué títulos hay y cómo cambiar los umbrales de tu clase.$itakai$, $itakai$/app/ayuda/niveles.svg$itakai$, $itakai$El nivel es la traducción de la experiencia acumulada en un número visible, y el rango es el título que lo acompaña.
...
El alumno ve una animación de subida de nivel al entrar. Si prefieres una clase más sobria, en el perfil de cada usuario se pueden [reducir las animaciones](/ayuda/tu-cuenta/accesibilidad).$itakai$, 'es', 'publicado'::"HelpArticleStatus", 3, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$gamificacion$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$la-vista-del-alumno$itakai$, $itakai$La vista del alumno$itakai$, $itakai$Qué ve tu alumnado al entrar y dónde encuentra cada cosa.$itakai$, $itakai$/app/ayuda/vista-alumno.svg$itakai$, $itakai$Conviene saber cómo se ve la plataforma desde el otro lado, porque muchas dudas de clase se resuelven sabiendo dónde está cada botón.
...
Puedes matricularte en tu propia clase como alumno de prueba para revisarla desde dentro. Esa matrícula no cuenta en los listados, ni en el recuento de alumnos, ni en la clasificación.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 0, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$alumnado$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$avatares-y-alias-por-clase$itakai$, $itakai$Avatares y alias por clase$itakai$, $itakai$Por qué la identidad es por clase y cómo se genera un avatar con inteligencia artificial.$itakai$, $itakai$/app/ayuda/avatares.svg$itakai$, $itakai$En ITAKAI la identidad de un alumno **es por clase, no por cuenta**. La misma persona puede ser "Capitana Nemo" en tu clase de Ciencias y "Aristóteles" en la de Filosofía, con avatares distintos.
...
Los alias y los avatares generados los ves tú en la ficha de cada alumno. Si algo no encaja, puedes pedir el cambio o editarlo desde la propia ficha. Merece la pena dejar claras las reglas del juego el primer día, en la [guía de clase](/ayuda/clases/la-guia-de-clase).$itakai$, 'es', 'publicado'::"HelpArticleStatus", 1, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$alumnado$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$clasificacion-y-progreso$itakai$, $itakai$Clasificación y progreso$itakai$, $itakai$Cómo se ordena el ranking, qué ve cada alumno y cómo seguir a uno en concreto.$itakai$, $itakai$/app/ayuda/clasificacion.svg$itakai$, $itakai$## La clasificación
...
El listado de alumnos se puede ordenar por nombre, nivel, experiencia, monedas, maná o vida, para encontrar rápido a quien va rezagado o a quien lleva semanas sin entregar.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$alumnado$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$que-hace-la-inteligencia-artificial$itakai$, $itakai$Atenea y los dioses: qué hace la IA$itakai$, $itakai$En qué te ayuda el asistente, dónde aparece y qué decide siempre el profesorado.$itakai$, $itakai$/app/ayuda/atenea.svg$itakai$, $itakai$La inteligencia artificial de ITAKAI es un asistente de escritura, no un piloto automático. **Propone; tú decides.** Nada de lo que genera se publica solo.
...
Todo lo demás funciona igual. Los botones de generación no aparecen y las clases se escriben a mano. Configurarla es cosa de administración: [configurar el proveedor de IA](/ayuda/ia-y-configuracion/configurar-el-proveedor-de-ia).$itakai$, 'es', 'publicado'::"HelpArticleStatus", 0, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$ia-y-configuracion$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$configurar-el-proveedor-de-ia$itakai$, $itakai$Configurar el proveedor de IA$itakai$, $itakai$Para administración: claves, modelos y límite de uso por hora.$itakai$, $itakai$/app/ayuda/proveedor-ia.svg$itakai$, $itakai$La inteligencia artificial se configura una vez, para toda la instancia, desde **Panel de administración → Configuración → Inteligencia artificial**.
...
Si no rellenas nada, la plataforma funciona igual pero sin los botones de generación. Es una opción legítima: hay centros que prefieren no usar IA.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 1, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$ia-y-configuracion$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$almacenamiento-de-archivos$itakai$, $itakai$Almacenamiento: disco local o bucket S3/R2$itakai$, $itakai$Para administración: dónde se guardan las entregas y las imágenes, y cómo cambiarlo.$itakai$, $itakai$/app/ayuda/almacenamiento.svg$itakai$, $itakai$Todo lo que se sube a la plataforma —entregas del alumnado, portadas de misión, insignias, avatares— tiene que guardarse en algún sitio. Se elige desde **Panel de administración → Configuración → Almacenamiento**.
...
Si tienes tu propia instancia, el disco local suele ser suficiente para un centro. El bucket empieza a compensar cuando hay varios centros o cuando las entregas incluyen vídeo.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$ia-y-configuracion$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$accesibilidad$itakai$, $itakai$Ajustes de accesibilidad$itakai$, $itakai$Tamaño de letra, contraste, modos para daltonismo y menos animación.$itakai$, $itakai$/app/ayuda/accesibilidad.svg$itakai$, $itakai$La plataforma tiene cuatro ajustes de accesibilidad que se guardan **en tu cuenta**, así que te acompañan de un ordenador del aula a otro.
...
Reduce las transiciones y los efectos de movimiento, incluida la animación de subir de nivel. Complementa al ajuste del sistema operativo, que en un ordenador compartido no siempre está a mano.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 0, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$tu-cuenta$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$avisos-y-recordatorios$itakai$, $itakai$Avisos y recordatorios$itakai$, $itakai$Qué te avisa la plataforma, por dónde te llega y cómo apagarlo.$itakai$, $itakai$/app/ayuda/avisos.svg$itakai$, $itakai$Los avisos aparecen **siempre dentro de la plataforma**, en la campana y en la página de notificaciones. El correo es opcional y se controla desde tu perfil.
...
En el que tengas puesta la interfaz. El aviso se compone en tu idioma en el momento de crearse, así que si lo cambias después, los anteriores se quedan como estaban.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 1, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$tu-cuenta$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$seguridad-de-tu-cuenta$itakai$, $itakai$Seguridad de tu cuenta$itakai$, $itakai$Cambiar la contraseña o el correo, y cerrar sesiones abiertas en otros equipos.$itakai$, $itakai$/app/ayuda/seguridad.svg$itakai$, $itakai$Todo está en tu **perfil, pestaña Seguridad**.
...
Si usas un ordenador de aula, cierra sesión al terminar. Los ajustes de accesibilidad se quedan guardados en tu cuenta, así que al volver a entrar en cualquier equipo los tienes otra vez sin tocar nada.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$tu-cuenta$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$como-entro-en-mi-clase$itakai$, $itakai$Cómo entro en mi clase$itakai$, $itakai$Con la invitación del profesor o con el código de la clase.$itakai$, $itakai$/app/ayuda/invitar.svg$itakai$, $itakai$Para estar en una clase de ITAKAI hace falta que tu profesor te meta. Hay dos caminos y los dos acaban en el mismo sitio.
...
La misma cuenta te vale para todas las clases y para todos los cursos. No hace falta crear una nueva cada año ni una por asignatura: tu progreso, tus insignias y tu avatar viajan contigo.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 0, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$si-eres-alumno$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$como-entrego-una-mision$itakai$, $itakai$Cómo entrego una misión$itakai$, $itakai$Dónde se entrega, qué se puede mandar y qué pasa después.$itakai$, $itakai$/app/ayuda/entregas.svg$itakai$, $itakai$Una misión es un trabajo con premio. Cuando la abres ves de qué va, qué tienes que hacer y qué te llevas si la completas.
...
Si la misión tiene fecha de entrega, te llega un aviso antes de que se cumpla. Entregar tarde puede costarte puntos de vida, según lo que haya decidido tu profesor para la clase.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 1, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$si-eres-alumno$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$que-son-el-xp-las-monedas-y-el-mana$itakai$, $itakai$Qué son el XP, las monedas y el maná$itakai$, $itakai$Tres cosas distintas que se ganan igual pero se usan para cosas muy diferentes.$itakai$, $itakai$/app/ayuda/recompensas.svg$itakai$, $itakai$Las misiones te dan tres cosas y es fácil confundirlas. Se ganan igual, pero no sirven para lo mismo.
...
Cada profesor elige qué recursos tiene su clase. Puede que en una uses las tres cosas y en otra solo XP. Mira el panel de la clase para ver qué hay en juego.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$si-eres-alumno$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$he-perdido-un-punto-de-vida$itakai$, $itakai$He perdido un punto de vida, ¿y ahora qué?$itakai$, $itakai$Qué son las vidas, por qué se pierden y cómo se recuperan.$itakai$, $itakai$/app/ayuda/comportamientos.svg$itakai$, $itakai$Los puntos de vida son la parte de la clase que mide cómo te comportas, no lo que entregas.
...
Habla con tu profesor. Los puntos de vida los mueve una persona a mano, así que también se pueden deshacer a mano. En la aplicación no hay ningún automatismo que te quite vidas por su cuenta.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 3, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$si-eres-alumno$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$mi-avatar-y-mi-nombre-en-clase$itakai$, $itakai$Mi avatar y mi nombre en clase$itakai$, $itakai$Cómo cambiar tu cara y tu alias, y dónde los ven los demás.$itakai$, $itakai$/app/ayuda/avatares.svg$itakai$, $itakai$En cada clase tienes un avatar y un alias. Son tuyos y puedes cambiarlos.
...
Hay clases donde el profesor deja el alias fijo para saber quién es quién. Si no te deja tocarlo, es eso: no es un fallo.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 4, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$si-eres-alumno$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$la-clasificacion-de-la-clase$itakai$, $itakai$La clasificación de la clase$itakai$, $itakai$Qué mide el ranking, quién lo ve y qué no se enseña nunca.$itakai$, $itakai$/app/ayuda/clasificacion.svg$itakai$, $itakai$Algunas clases tienen clasificación y otras no: lo decide tu profesor.
...
Si te has incorporado con el curso empezado vas a estar abajo, y es normal: los demás llevan más misiones hechas. Lo que cuenta para tu nota no es el puesto, es lo que entregas.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 5, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$si-eres-alumno$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$no-llega-el-correo-de-invitacion$itakai$, $itakai$No llega el correo de invitación$itakai$, $itakai$Los tres motivos habituales, por orden de probabilidad.$itakai$, $itakai$/app/ayuda/correo-invitacion.svg$itakai$, $itakai$Es lo que más se pregunta al empezar el curso. Casi siempre es una de estas tres cosas.
...
Si tu instancia está recién montada y no ha salido ningún correo todavía, revisa la configuración de envío en el panel de administración antes de buscar culpables fuera.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 0, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$cuando-algo-falla$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$un-alumno-no-ve-la-clase$itakai$, $itakai$Un alumno no ve la clase$itakai$, $itakai$Dice que ha entrado pero su clase no aparece por ningún lado.$itakai$, $itakai$/app/ayuda/acceso-clase.svg$itakai$, $itakai$El alumno entra, llega a su panel y la clase no está. Repasa esto en orden.
...
Si todo lo anterior está bien, que cierre sesión y vuelva a entrar. El panel se carga al entrar, y una sesión que lleva días abierta puede estar enseñando una lista vieja.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 1, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$cuando-algo-falla$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$la-ia-no-responde$itakai$, $itakai$La IA no responde$itakai$, $itakai$Qué mirar cuando Atenea se queda en blanco o tarda demasiado.$itakai$, $itakai$/app/ayuda/ia-en-silencio.svg$itakai$, $itakai$La IA de ITAKAI habla con un proveedor externo. Cuando no contesta, el problema suele estar en ese enlace.
...
Generar un texto largo o una imagen lleva su tiempo. Dale unos segundos antes de darlo por perdido y no pulses el botón varias veces: cada pulsación es una petición nueva.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 2, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$cuando-algo-falla$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$no-puedo-subir-un-archivo$itakai$, $itakai$No puedo subir un archivo$itakai$, $itakai$Tamaño, formato y dónde se guardan las cosas.$itakai$, $itakai$/app/ayuda/subida-fallida.svg$itakai$, $itakai$Las subidas fallan casi siempre por el tamaño o por el formato.
...
Que pruebe desde otro navegador o desde otro dispositivo. Una extensión del navegador que bloquea peticiones puede cortar la subida sin decir nada.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 3, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$cuando-algo-falla$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$he-borrado-algo-sin-querer$itakai$, $itakai$He borrado algo sin querer$itakai$, $itakai$Qué se puede recuperar, qué no, y cómo evitar el susto.$itakai$, $itakai$/app/ayuda/deshacer.svg$itakai$, $itakai$Antes de nada: no vuelvas a crearlo a toda prisa. Mira primero si de verdad se ha ido.
...
Antes de un cambio grande —reorganizar un trimestre, limpiar misiones viejas— duplica la clase. La copia te queda como red de seguridad y se hace en un momento.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 4, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$cuando-algo-falla$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$las-recompensas-no-cuadran$itakai$, $itakai$Las recompensas no cuadran$itakai$, $itakai$Un alumno recibe menos XP o menos monedas de las que esperaba.$itakai$, $itakai$/app/ayuda/recompensas-descuadradas.svg$itakai$, $itakai$Casi siempre es que se está mirando el número de la misión y cobrando el del enigma, o al revés.
...
Abre la entrega concreta: ahí se ve el porcentaje que pusiste y lo que se pagó por él.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 5, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$cuando-algo-falla$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;

INSERT INTO "help_articles" ("id", "category_id", "slug", "title", "summary", "cover_image", "body", "locale", "status", "order_index", "featured", "published_at", "updated_at")
SELECT gen_random_uuid()::text, c."id", $itakai$no-puedo-entrar-en-mi-cuenta$itakai$, $itakai$No puedo entrar en mi cuenta$itakai$, $itakai$Contraseña, Google y las cuentas duplicadas.$itakai$, $itakai$/app/ayuda/cuenta-bloqueada.svg$itakai$, $itakai$Antes de crear otra cuenta —que es lo que todo el mundo hace y complica el arreglo—, prueba esto.
...
Que tu profesor o quien administre la instancia compruebe que la cuenta existe y está activa con el correo que tú crees. Desde ahí se ve enseguida si el problema es la cuenta o la contraseña.$itakai$, 'es', 'publicado'::"HelpArticleStatus", 6, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM "help_categories" c WHERE c."slug" = $itakai$cuando-algo-falla$itakai$
ON CONFLICT ("category_id", "slug", "locale") DO NOTHING;
